...
public class ErrorConstants {
	...
	public static final int NOT_EXIST_EBIKE = 200;//Lock Not Found！
	public static final int ALREADY_MEMBERSHIP = 201;//Lock Already Open！
	public static final int NO_MEMBERSHIP = 202;//Lock Already Closed！
	public static final int ALREADY_RENEW = 203;//Lock Lack History！
	public static final int GET_PIN_TOO_FAST = 300;//Get PIN Code Too Fast！
	public static final int SMS_PIN_INVALID = 301;//SMS Pin Invalid！
